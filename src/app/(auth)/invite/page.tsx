...
const inputCls = "w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#122F38]/20 focus:border-[#122F38] transition-colors text-center tracking-widest text-lg font-mono uppercase";
...
export default function InvitePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/register-lifetime?token=${data.token}`);
    } catch {
      ...
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            You have been granted free lifetime access to Averis Academy. Enter your invite code below to get started.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading || !code.trim()} className={btnCls}>
